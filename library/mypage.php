...
<body>
        ...
        <div class="content-box">
            ...
            <div style="margin-top: 20px;">
                <form action="logout.php" method="POST">
                    <button type="submit" style="padding: 10px 20px; background-color: #555; color: white; border: none; border-radius: 5px;">로그아웃</button>
                </form>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function toggleScroll() {
            document.body.style.overflow = document.getElementById('scroll-toggle').checked ? 'auto' : 'hidden';
        }
    </script>
</body>
</html>
